...
export function generateOrganizationSchema() {
  return {
    ...
    url: process.env.NEXT_PUBLIC_APP_URL || "https://tech-linkup.vercel.app",
    logo: `${process.env.NEXT_PUBLIC_APP_URL || "https://tech-linkup.vercel.app"}/assets/Logo/linkup-logo.png`,
    description:
