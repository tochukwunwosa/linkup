...
export default function BackgroundSlideButton({ children, className, onClick }: BackgroundSlideButtonProps) {
  return (
    <button onClick={onClick} className={cn("rounded-xl bg-inherit flex items-center justify-center cursor-pointer group overflow-hidden relative text-primary shadow-xl hover:shadow-2xl transition-all duration-300", className)}>
