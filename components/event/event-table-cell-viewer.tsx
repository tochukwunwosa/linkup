...
export function TableCellViewer({ item }: { item: z.infer<typeof eventSchema> }) {
          ...
          <form className="flex flex-col gap-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="flex flex-col gap-3">
                ...
                <Input id="date" defaultValue={item.start_date} />
              </div>
            </div>date
            <div className="flex flex-col gap-3">
              ...
              <Select defaultValue={item.location}>
                ...
                <SelectContent>
                  <SelectItem value={item.location}>{item.location}</SelectItem>
                </SelectContent>
              </Select>
            </div>
          </form>
